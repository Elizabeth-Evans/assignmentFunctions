...
// The answer is [C]. "y" prints out second because it was asked to print second by the "1". "x" doesn't print at all because it is not console.log(ed).
...
// function colorName() {
//   console.log(colorName.toLowerCase()===spanishColor);
// }


spanishColor = (colorName.toLowerCase());
return spanishColor.colorName;
// Put your answer below -------------------------
